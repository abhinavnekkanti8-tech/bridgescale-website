...
(function (RegisterRole) {
    RegisterRole["STARTUP_ADMIN"] = "STARTUP_ADMIN";
    RegisterRole["OPERATOR"] = "OPERATOR";
...
__decorate([
    (0, class_validator_1.IsEnum)(RegisterRole, { message: 'Role must be STARTUP_ADMIN or OPERATOR.' }),
    __metadata("design:type", String)
