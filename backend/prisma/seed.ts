  ...
  const templates = [
    {
      ...
      templateType: SowTemplateType.PIPELINE_SPRINT,
      description: '30-day outbound pipeline generation sprint in a target international market.',
      durationDays: 30,
      suggestedFeeMin: 250000,  // $2,500 in cents
      suggestedFeeMax: 400000,  // $4,000 in cents
      currency: 'USD',
      placeholders: [
...
BridgeScale: _________________________ Date: __________`,
    },
    {
      ...
      templateType: SowTemplateType.BD_SPRINT,
...
BridgeScale: _________________________ Date: __________`,
    },
    {
      ...
      templateType: SowTemplateType.FRACTIONAL_RETAINER,
      description: '90-day fractional sales leadership engagement — owns and leads international sales motion at 15–20 hrs/week.',
      durationDays: 90,
      suggestedFeeMin: 500000,   // $5,000/mo in cents
      suggestedFeeMax: 1000000,  // $10,000/mo in cents
      currency: 'USD',
      placeholders: [
        { name: 'company_name', description: 'Legal name of the client company', required: true },
...
BridgeScale: _________________________ Date: __________`,
    },
    {
      ...
      templateType: SowTemplateType.HYBRID_EQUITY,
      description: '6-month fractional BD leadership with a hybrid cash and equity (FAST) compensation structure.',
      durationDays: 180,
      suggestedFeeMin: 200000,   // $2,000/mo cash component floor
      suggestedFeeMax: 600000,   // $6,000/mo cash component ceiling
      currency: 'USD',
      placeholders: [
        { name: 'company_name', description: 'Legal name of the client company', required: true },
        { name: 'talent_name', description: 'Full name of the fractional leader', required: true },
